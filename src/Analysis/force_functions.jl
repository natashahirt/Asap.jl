...
MLine(::Element{FreeFree}, w, L, x) = MLine_freefree(w, L, x)
MLine(::Element{Joist}, w, L, x) = MLine_freefree(w, L, x)
...
VLine(::Element{FreeFree}, w, L, x) = VLine_freefree(w, L, x)
VLine(::Element{Joist}, w, L, x) = VLine_freefree(w, L, x)
...
DLine(::Element{FreeFree}, w, L, x, E, I) = DLine_freefree(w, L, x, E, I)
DLine(::Element{Joist}, w, L, x, E, I) = DLine_freefree(w, L, x, E, I)
...
ThetaLine(::Element{FreeFree}, w, L, x, E, I) = ThetaLine_freefree(w, L, x, E, I)
ThetaLine(::Element{Joist}, w, L, x, E, I) = ThetaLine_freefree(w, L, x, E, I)
...
MLine(::Element{FixedFixed}, w, L, x) = MLine_fixedfixed(w, L, x)
...
VLine(::Element{FixedFixed}, w, L, x) = VLine_fixedfixed(w, L, x)
...
DLine(::Element{FixedFixed}, w, L, x, E, I) = DLine_fixedfixed(w, L, x, E, I)
...
ThetaLine(::Element{FixedFixed}, w, L, x, E, I) = ThetaLine_fixedfixed(w, L, x, E, I)
...
MLine(::Element{FreeFixed}, w, L, x) = MLine_freefixed(w, L, x)
...
VLine(::Element{FreeFixed}, w, L, x) = VLine_freefixed(w, L, x)
...
DLine(::Element{FreeFixed}, w, L, x, E, I) = DLine_freefixed(w, L, x, E, I)
...
ThetaLine(::Element{FreeFixed}, w, L, x, E, I) = ThetaLine_freefixed(w, L, x, E, I)
...
MLine(::Element{FixedFree}, w, L, x) = MLine_fixedfree(w, L, x)
...
VLine(::Element{FixedFree}, w, L, x) = VLine_fixedfree(w, L, x)
...
DLine(::Element{FixedFree}, w, L, x, E, I) = DLine_fixedfree(w, L, x, E, I)
...
ThetaLine(::Element{FixedFree}, w, L, x, E, I) = ThetaLine_fixedfree(w, L, x, E, I)
...
MPoint(::Element{FreeFree}, P, L, x, frac) = MPoint_freefree(P, L, x, frac)
...
VPoint(::Element{FreeFree}, P, L, x, frac) = VPoint_freefree(P, L, x, frac)
...
DPoint(::Element{FreeFree}, P, L, x, frac, E, I) = DPoint_freefree(P, L, x, frac, E, I)
...
ThetaPoint(::Element{FreeFree}, P, L, x, frac, E, I) = ThetaPoint_freefree(P, L, x, frac, E, I)
...
MPoint(::Element{FixedFixed}, P, L, x, frac) = MPoint_fixedfixed(P, L, x, frac)
...
VPoint(::Element{FixedFixed}, P, L, x, frac) = VPoint_fixedfixed(P, L, x, frac)
...
DPoint(::Element{FixedFixed}, P, L, x, frac, E, I) = DPoint_fixedfixed(P, L, x, frac, E, I)
...
ThetaPoint(::Element{FixedFixed}, P, L, x, frac, E, I) = ThetaPoint_fixedfixed(P, L, x, frac, E, I)
...
MPoint(::Element{FreeFixed}, P, L, x, frac) = MPoint_freefixed(P, L, x, frac)
...
MPoint(::Element{FixedFree}, P, L, x, frac) = MPoint_fixedfree(P, L, x, frac)
...
VPoint(::Element{FreeFixed}, P, L, x, frac) = VPoint_freefixed(P, L, x, frac)
...
VPoint(::Element{FixedFree}, P, L, x, frac) = VPoint_fixedfree(P, L, x, frac)
...
DPoint(::Element{FreeFixed}, P, L, x, frac, E, I) = DPoint_freefixed(P, L, x, frac, E, I)
...
DPoint(::Element{FixedFree}, P, L, x, frac, E, I) = DPoint_fixedfree(P, L, x, frac, E, I)
...
ThetaPoint(::Element{FreeFixed}, P, L, x, frac, E, I) = ThetaPoint_freefixed(P, L, x, frac, E, I)
...
ThetaPoint(::Element{FixedFree}, P, L, x, frac, E, I) = ThetaPoint_fixedfree(P, L, x, frac, E, I)